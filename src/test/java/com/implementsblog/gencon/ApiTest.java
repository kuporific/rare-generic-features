...
public class ApiTest {
    ...
    public void testGenericDeclarationsOnConstructors() {
        ...
        List<Tuple2<Path, List<ConstructorDeclaration>>> allGenericDeclarationsOnConstructors
                = m.getAllGenericDeclarationsOnConstructors().collect(toList());
        prettyPrint(allGenericDeclarationsOnConstructors);
        System.out.println(m.toCounts(allGenericDeclarationsOnConstructors.stream()));
...
//    }
    ...
    private void prettyPrint(List<Tuple2<Path, List<ConstructorDeclaration>>> data) {
